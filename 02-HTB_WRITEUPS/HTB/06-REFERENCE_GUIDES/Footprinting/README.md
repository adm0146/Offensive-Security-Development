...
- [Enumeration_Principles.md](Enumeration_Principles.md) — Core philosophy: what we see vs don't see, active vs passive recon, and the three principles of effective enumeration.
...
ca- [SMTP.md](SMTP.md) — Simple Mail Transfer Protocol: ports 25/587/465, ESMTP, mail flow (MUA→MSA→MTA→MDA), VRFY user enumeration, and open relay attacks.
...
- [Windows_Remote_Management.md](Windows_Remote_Management.md) — RDP, WinRM, and WMI: TCP 3389/5985/5986/135, NLA detection, rdp-sec-check, evil-winrm, Impacket wmiexec.py, and xfreerdp.
