...
DCSync mimics a Domain Controller requesting password replication from another DC using the **DS-Replication-Get-Changes-All** extended right. The target DC responds with every user's NTLM hash and Kerberos keys — the same data in NTDS.dit.

**Required rights (both needed):**
- `DS-Replication-Get-Changes`
- `DS-Replication-Get-Changes-All`

**Who has these by default:** Domain Admins, Enterprise Admins, Domain Controllers.

**How attackers get here:** ACL abuse chain. Any non-DC account granted replication rights (misconfiguration or software like Exchange) is DCSync capable.
