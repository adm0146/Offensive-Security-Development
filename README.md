...
├── 00-roadmap/                    # OSCP roadmap PDF and planning docs
├── 01-python-fundamentals/        # Pre-phase Python learning
├── 02-foundation/                 # Phase 1: Linux, nmap, web basics
├── 03-pwk-content/               # Phase 2: PWK modules 1-5
├── 04-labs-writeups/             # Phases 3-4: PWK machine writeups
├── 05-advanced-exploitation/      # Phase 5: Advanced techniques
├── 06-active-directory/           # Phase 6: AD exploitation mastery
├── 07-tools-scripts/              # Custom exploitation scripts
├── 08-reference-guides/           # Cheat sheets, technique references
├── 09-htb-writeups/              # HackTheBox machine writeups
└── README.md                      # This file
```

## Key Techniques to Master

- Nmap enumeration and scripting
...
- Web application attacks (XSS, CSRF, etc.)

## Study Approach

1. **Watch & Take Light Notes** - Professor Messer Security+ videos as foundation
2. **Active Learning** - Immediate practice via HackTheBox/TryHackMe
3. **Detailed Writeups** - Document every machine (forces deep understanding)
4. **Technique Mastery** - Build custom exploits for each technique
5. **Review & Consolidate** - Weekly writeup consolidation, progress tracking

## Success Factors

- ✅ **7-9 AM Sacred Block** - Protected OSCP time every single day (12 hrs/week)
- ✅ **Saturday Extended Block** - 5-hour focus sessions (largest continuous work block)
- ✅ **Gym 5x/Week** - Physical fitness drives cognitive performance
- ✅ **Sleep 8+ Hours** - Non-negotiable for learning retention
- ✅ **Detailed Writeups** - Document every machine, build knowledge base
- ✅ **Weekly Tracking** - Log progress, celebrate wins

## Learning Resources

- **HackTheBox VIP** ($14/mo) - Practice machines
- **TryHackMe Premium** ($10/mo) - Structured learning paths
- **Violent Python** - Python exploitation fundamentals
- **PEN-200 Course** (Mar 1 enrollment) - Official PWK content
- **Proving Grounds** - Hard/Insane difficulty machines
- **NetworkChuck YouTube** - Supplementary video content
...
This is a private repository documenting my OSCP certification journey. All writeups, scripts, and documentation are created as part of the learning process.

---

**Last Updated:** January 2, 2026
**Repository Status:** Active - Ongoing OSCP Preparation
